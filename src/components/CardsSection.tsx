...
const CardsSection = ({
  ...
  return (
    <section
      className={`${pageId === "Shakespeare" ? "w-full flex flex-col items-start my-8 gap-56 md:gap-32" : "w-full grid grid-cols-1 md:grid-cols-2 items-center pt-16 pb-24 md:py-24 gap-52 md:gap-36"}`}
    >
      {shuffledPoems &&
